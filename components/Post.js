...
const Post = ({ name, message, email, timestamp, image, postImage }) => {
  return (
    <div className="flex flex-col">
      <div className="p-5 bg-white mt-2 rounded-t-xl shadow-md">
      ...
      <div className="flex justify-between items-center rounded-b-xl bg-white shadow-md text-gray-400 border-t">
        <div className="input-icon  rounded-none rounded-bl-xl">
        ...
        <div className="input-icon  rounded-none rounded-br-xl">
